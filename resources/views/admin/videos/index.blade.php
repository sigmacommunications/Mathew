                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold float-left">Video</h6>
                                <a class="btn btn-primary btn-sm float-right" href="{{ route('videos.create') }}"><i
                                        class="fa fa-plus"></i>
                                    Add
                                    New
                                    Videos</a>
                                ...
                                <table id="example" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Title</th>
                                            <th>Video</th>
                                            <th>Thumbnail</th> <!-- Added column for Thumbnail -->
                                            <th>Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody>
