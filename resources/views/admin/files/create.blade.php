                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold float-left">New File Uploads
                                </h6>
                                    ...
                                    <table class="table table-bordered" id="categories-table">
                                        ...
                                        <tbody>
                                            <tr class="category-input">
                                                ...
                                                <td><input type="text" name="category_amounts[]"
                                                        class="form-control category-amount">
                                                </td>
                                                <td><input type="file" name="category_files[]" class="form-control"></td>
                                                <td><button type="button" class="btn btn-primary" id="add-category">Add
                                                        More</button></td>
                                            </tr>
                                        </tbody>
                                    </table>
