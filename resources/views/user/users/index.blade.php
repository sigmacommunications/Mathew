...
@section('content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('users.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fa fa-plus"></i> Add User</a>
    </div>
    <div class="card-body">
                ...
                <tr>
                    ...
                    <td>
                        @if(!empty($user))
                            ...
                            @if(isset($roles[0]))
                                <label class="badge badge-primary">{{ Str::ucfirst($roles[0])  }}</label>
                            @endif
                        @endif
                    </td>
